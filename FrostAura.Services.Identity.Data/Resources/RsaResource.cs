...
namespace FrostAura.Services.Identity.Data.Resources
{
    /// <summary>
    /// Derrived from https://gist.github.com/mykeels/408a26fb9411aff8fb7506f53c77c57a
    /// </summary>
    public class RsaResource
    {
        ...
        public RsaResource(TimeSpan timeSpan, string keyFilePath)
        {
            _file = keyFilePath;
            _timeSpan = timeSpan;
        }
        ...
        public RsaResource GenerateKeyAndSave(bool forceUpdate = false)
        {
